...
<title>SmartHouse - Bathroom</title>
...
<body>
	...
	<div class="container">
		...
		<img src="images/bathroom.png" class="house_img img-responsive">
		<div class="action_btn">
			<p class="action">Actions</p>
			<?php if(isset($_SESSION['login_in'])): ?>
				<img src="images/lightbulb<?php echo $row['lightbulb'];?>.png" id="lightbulb" onclick="actionState(<?php echo $row['lightbulb'];?>,'bathroom','lightbulb')">
				<img src="images/outlet<?php echo $row['outlet'];?>.png" id="outlet" onclick="actionState(<?php echo $row['outlet'];?>,'bathroom','outlet')">
				<img src="images/curtain<?php echo $row['curtain'];?>.png" id="curtain" onclick="actionState(<?php echo $row['curtain'];?>,'bathroom','curtain')">
			<?php else:?>
