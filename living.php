...
<body>
	...
	<div class="container">
		<p class="room_name">Living<p>
		<img src="images/living.png" class="house_img img-responsive">
		<div class="action_btn">
			<p class="action">Actions</p>
			<?php if(isset($_SESSION['login_in'])): ?>
				<img src="images/lightbulb<?php echo $row['lightbulb'];?>.png" id="lightbulb" onclick="actionState(<?php echo $row['lightbulb'];?>,'livingroom','lightbulb')">
				<img src="images/outlet<?php echo $row['outlet'];?>.png" id="outlet" onclick="actionState(<?php echo $row['outlet'];?>,'livingroom','outlet')">
				<img src="images/curtain<?php echo $row['curtain'];?>.png" id="curtain" onclick="actionState(<?php echo $row['curtain'];?>,'livingroom','curtain')">
			<?php else:?>
