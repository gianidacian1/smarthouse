...
<body>
	...
	<div class="container">
		...
		<img src="images/room1.png" class="house_img img-responsive">
		<div class="action_btn">
			<p class="action">Actions</p>
			<?php if(isset($_SESSION['login_in'])): ?>
				<img src="images/lightbulb<?php echo $row['lightbulb'];?>.png" id="lightbulb" onclick="actionState(<?php echo $row['lightbulb'];?>,'room1','lightbulb')">
				<img src="images/outlet<?php echo $row['outlet'];?>.png" id="outlet" onclick="actionState(<?php echo $row['outlet'];?>,'room1','outlet')">
				<img src="images/curtain<?php echo $row['curtain'];?>.png" id="curtain" onclick="actionState(<?php echo $row['curtain'];?>,'room1','curtain')">
			<?php else:?>
